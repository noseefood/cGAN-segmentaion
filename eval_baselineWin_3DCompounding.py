...
class Evaluation():
    ...
    def start(self):
        ...
        for i,(input, target) in enumerate(zip(self.imgs,self.masks)):
            ...
            # cnts_DeeplabV3Plus = cv2.findContours(output_DeeplabV3Plus, cv2.RETR_EXTERNAL, cv2.CHAIN_APPROX_SIMPLE)[-2]
            ...
            # self.vis_minAreaRect(img, output_DeeplabV3Plus, cnts_DeeplabV3Plus, color=(0, 125, 125))
            ...
            # self.vis_maxAreaRect(img, output_DeeplabV3Plus, cnts_DeeplabV3Plus, color=(0, 255, 0), model="output_DeeplabV3Plus")
